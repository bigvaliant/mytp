...
class Email
{
    ...
    public function __construct($options = [])
    {
        ...
        $this->mail->SMTPDebug = $this->options['debug'];          // Enable verbose debug output
        $this->mail->isSMTP();                                      // Set mailer to use SMTP
        $this->mail->Host = $this->options['mail_smtp_host'];  // Specify main and backup SMTP servers
        ...
        $this->mail->SMTPSecure = isset($securArr[$this->options['mail_verify_type']]) ? $securArr[$this->options['mail_verify_type']] : '';  // Enable TLS encryption, `ssl` also accepted
        $this->mail->Port = $this->options['mail_smtp_port'];

        //设置发件人
        $this->from($this->options['mail_from'],$this->options['name']);
    }
